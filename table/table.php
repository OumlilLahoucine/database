...
<html lang="en">
<head>
    <title>Database : Table Managment</title>
    <?php
            ...
            <div class="row">
                <div class="col-6 col-md-4 col-lg-3">
                    <form action="table.php" method="post">
                        <label for="select_database" class="text-black mb-3">Select database : </label>
                        <input list="databases" value="<?php if(isset($db)) echo $db; ?>" name="database" id="select_database" class="outline-none py-1 rounded">
                        ...
                        <input type="submit" value="Refresh" name="refresh" class="btn main-btn rounded text-uppercase mt-3 mb-5 w-100">
                    </form>
                    <i class="fa-solid fa-table icon text-green-color"></i>
